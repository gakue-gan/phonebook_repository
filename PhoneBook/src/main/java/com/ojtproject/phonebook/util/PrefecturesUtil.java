...
public class PrefecturesUtil {

	public static Map<String, String> getPrefecturesMap() {
		...
		PrefecturesMap.put("26", "京都県");
		PrefecturesMap.put("27", "大阪県");
